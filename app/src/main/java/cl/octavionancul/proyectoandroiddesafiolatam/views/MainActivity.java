...
public class MainActivity extends AppCompatActivity {
    ...
    /*     String key = new Nodes().exercises().push().getKey();
        ...
        exe.setName("Sentadilla");
        exe.setOwner("jksfksdfks");
        exe.setReps(12);
        exe.setSets(4);
        exe.setWeight(10);
        exe.setVolume(12*4*20);

        Log.d("key",key);

        //   FirebaseDatabase.getInstance().getReference().push().child("eventos").child(key).setValue(exe);
      new Nodes().userExercise("jljnljhodhojsi").child(key).setValue(exe);*/
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DialogFragment dialogFragment = ExerciseInputDialogFragment.newInstance();
